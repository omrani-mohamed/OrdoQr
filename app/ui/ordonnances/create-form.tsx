        ...
        <div className="mb-4">
          ...
          {medications.map((medication, index) => (
            <div key={index} className="mb-4 flex lg:flex-row sm:flex-col max-sm:flex-col">
              ...
              <button
                type="button"
                className="mt-6 mb-6 inline-flex items-center border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700"
